  ...
  return (
    <>
      ...
      <section className="d-flex  justify-content-around flex-md-row-reverse flex-row align-items-center row pt-5 mb-5">
        ...
        <div className="col-11 col-lg-6 col-xl-6 col-xxl-5 d-flex justify-content-center align-items-start flex-column mt-5 about-content">
          <h1 className="align-self-center header-font my-5 ">درباره من </h1>
          <p className="px-0  px-md-2 px-lg-3 text-font">
